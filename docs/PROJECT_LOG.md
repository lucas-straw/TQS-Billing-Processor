...
|---|---|---|---|
| v2.4.4 | 2026-05-12 | Add `otRate` field name diagnostic to parse log (first agreement's field list + per-agreement otRate value) to identify correct N8N field name. | `pending` |
